...
It loks quite good from the year 2000. 
Imputing data:
...
```
I dont think I had to define NIunits above. I still get the index per BSunit here:
```{r}
NI$N$`1990`$BSunitIndices[1,1]
```

There are 10000 estimates per BSunit. Here are thefisrt 3 for Bodø
```{r}
